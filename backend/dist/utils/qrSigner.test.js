...
describe('qrSigner', () => {
    it('buildQrPayload genera un JSON con ticket_id, event_id, seat y firma', () => {
        const payload = (0, qrSigner_1.buildQrPayload)({ ticketId: 'TK-1', eventId: 'EV-1', seat: 'A-1' });
    ...
    it('parsearQr devuelve null si el JSON es inválido', () => {
        expect((0, qrSigner_1.parsearQr)('no-es-json')).toBeNull();
    });
    it('parsearQr parsea correctamente un payload válido', () => {
        const payload = (0, qrSigner_1.buildQrPayload)({ ticketId: 'TK-2', eventId: 'EV-2', seat: 'B-2' });
        const parsed = (0, qrSigner_1.parsearQr)(payload);
